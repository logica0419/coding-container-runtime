...
ハンズオンパートをスムーズに進めるため、**Dev Container**か**ローカルLinux**のどちらかを準備してください。
...
ご自身の使っているエディタが**Dev Containerに対応**している場合、その手順に従って構築してください。
...
以下のような手段が取れるかと思います。ご興味があれば挑戦してみてください。
...
作業ディレクトリで以下のコマンドを実行し、必要なファイルを生成してください。
...
セットアップが終わったら、`make check`コマンドで確かめてください。  
